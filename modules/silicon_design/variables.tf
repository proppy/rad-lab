...
variable "boot_disk_size_gb" {
  description = "The size of the boot disk in GB attached to this instance. {{UIMeta group=3 order=5 }}"
  type        = number
  default     = 100
}

variable "boot_disk_type" {
  description = "Disk types for notebook instances. {{UIMeta group=3 order=4 }}"
  type        = string
  default     = "PD_SSD"
}
...
variable "machine_type" {
  description = "Type of VM you would like to spin up. {{UIMeta group=3 order=3 }}"
  type        = string
...
variable "notebook_count" {
  description = "Number of AI Notebooks requested. {{UIMeta group=3 order=1 updatesafe }}"
  type        = number
  default     = 1
}

variable "notebook_names" {
  description = "Names of AI Notebooks requested. {{UIMeta group=3 order=2 }}"
  type        = list(string)
  default     = []
}
